...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/spyder-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/spyder-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add spyder spyder-base
# for installing globally
pixi global install spyder spyder-base
```
...
It is possible to list all of the versions of `spyder` available on your platform:
...
```
pixi search spyder --channel conda-forge/label/spyder_dev
```
